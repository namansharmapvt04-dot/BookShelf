# Generated by Django 6.0.3 on 2026-03-25 06:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('want_to_read', 'Want to Read'), ('reading', 'Reading'), ('completed', 'Completed')], default='want_to_read', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sessions', to='api.userbook')),
            ],
            options={
                'ordering': ['-date'],
            },
